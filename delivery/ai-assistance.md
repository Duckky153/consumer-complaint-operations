...
- required requirements, acceptance criteria, quality controls, tests,
  limitations, recommendations, and handoff evidence;
- prohibited branding, false client claims, unnecessary infrastructure,
...
- researched the official CFPB source and public engineering material;
- proposed the bounded product-year population;
- drafted the business case, six requirements, architecture, and controls;
...
- performed local functional, data, syntax, accessibility, and visual checks.

## Human-control model

The implementation followed a controlled sequence:

1. Dakshit set the objective and non-negotiable boundaries.
2. Requirements and acceptance criteria were written before the finished UI.
3. The source and architecture were kept bounded.
